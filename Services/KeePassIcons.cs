...
public static class KeePassIcons
{
    ...
    private static string GetKeySvg() => "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"currentColor\"><path d=\"M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1 7.78 0l-.54.54a.75.75 0 1 0 1.06-1.06l.54-.54a6.975 6.975 0 1 0-9.83 0l-2.22 2.22a.75.75 0 1 0 1.06 1.06L9 9a4 4 0 0 1 4-4l2.5 2.5M9 15l2.5-2.5\"/></svg>";
